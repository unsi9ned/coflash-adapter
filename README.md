...
_CoFlash Adapter_ - это программа-транслятор, заменяющий штатный coflash.exe в среде CoIDE. Она перехватывает команды от CoIDE и перенаправляет их либо в оригинальный [_CoFlash_](https://github.com/unsi9ned/coflash), либо в _pyOCD_, в зависимости от того, какая утилита поддерживает целевой микроконтроллер.
